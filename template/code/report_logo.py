...
logos = documnet.add_paragraph()
logos.alignment = WD_ALIGN_PARAGRAPH.RIGHT 
logos.add_run().add_picture(r'../image/roa.png',height=Cm(1),width=Cm(1))
# 회사 로고 추가 
dates = documnet.add_paragraph()
dates.alignment = WD_ALIGN_PARAGRAPH.RIGHT 
dayoftoday = dates.add_run(f'작성일 : {date.today()}')
dayoftoday.font.size = Pt(10)
dayoftoday.font.color.rgb = RGBColor(128,128,128)
# 회색으로다가
# 오늘 날짜 추가 
